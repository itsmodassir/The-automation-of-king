    ...
    return (
        <aside className="w-64 bg-black text-white p-6 hidden md:flex flex-col dark:bg-slate-900 border-r dark:border-slate-800">
            ...
            <nav className="flex-1 space-y-4 text-sm font-medium">
                ...
                <a href="/inbox" className="block hover:text-gray-400">Inbox</a>
                <a href="/contacts" className="block hover:text-gray-400">Contacts</a>
                <a href="/automation" className="block hover:text-gray-400">Automation</a>
                <a href="/analytics" className="block hover:text-gray-400">Analytics</a>
                <div className="pt-10 text-xs uppercase tracking-widest text-gray-500 font-bold">Settings</div>
                <a href="/whatsapp" className="block hover:text-gray-400">WhatsApp</a>
                <a href="/team" className="block hover:text-gray-400">Team</a>
                <a href="/billing" className="block hover:text-gray-400">Billing</a>
                <a href="/settings" className="block hover:text-gray-400">Settings</a>
            </nav>
